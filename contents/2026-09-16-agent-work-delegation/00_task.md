# AI 에이전트 시대, 업무 위임을 설계하는 역량 — 작업 요청

- 작업 시작일: 2026-09-16
- 산출물 형식: both
- 실행 방식: 현재 대화에서 작성 / 별도 API 호출 없음
- 이미지 작업: chat (plan: 기획까지, chat: 대화 도구로 실제 생성)
- 상태: 원고 사실·내용 검수 완료 / 이미지 2종 생성·연결 / HTML 합성 완료
- 결과·보류 항목: 07_review.md 참조

## Codex에 전달할 요청

이 폴더의 주제는 'AI 에이전트 시대, 업무 위임을 설계하는 역량'입니다. 루트 AGENTS.md, prompts/README.md,
...
카드뉴스가 작성된 경우 저장소 루트에서 다음을 실행합니다.
    ...
    python3 scripts/build_cardnews.py contents/2026-09-16-agent-work-delegation
